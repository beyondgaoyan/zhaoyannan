...
$num=C::t('#aljbd#aljbd_album')->count_by_uid_bid($bd['uid'],$_GET['bid']);
$alist=C::t('#aljbd#aljbd_album')->fetch_all_by_uid_bid($bd['uid'],$_GET['bid'],$start,$perpage);

...
$check=C::t('#aljbd#aljbd_username')->fetch($_G['uid']);
...
$perpage=9;
$num=C::t('#aljbd#aljbd_notice')->count_by_uid_bid($bd['uid'],$_GET['bid']);
$allpage=ceil($num/$perpage);
$start=($currpage-1)*$perpage;
$nlist=C::t('#aljbd#aljbd_notice')->fetch_all_by_uid_bid($bd['uid'],$_GET['bid'],$start,$perpage);
